# Informe Final: Sistematización del Tema de Investigación con IA

---

## 1. Selección de la Línea de Investigación

**Línea de Investigación Seleccionada:** Inteligencia Artificial aplicada a la Ciberseguridad

Esta línea de investigación fue seleccionada debido a la creciente importancia de la ciberseguridad en el entorno digital actual y el potencial transformador de la inteligencia artificial para mejorar las capacidades de detección, prevención y respuesta ante amenazas cibernéticas.

---

## 2. Lluvia de Ideas con 3 LLM

### Tabla Comparativa de Propuestas

| Aspecto | ChatGPT | Grok | Gemini |
|---------|---------|------|--------|
| **Propuesta 1** | Detección de intrusiones con IA | Detección de Amenazas | Inteligencia de Amenazas y Defensa Proactiva |
| **Tema General 1** | Inteligencia Artificial para detección de intrusiones en redes | Uso de Inteligencia Artificial para la predicción y prevención de ciberataques. Esta área se enfoca en anticipar las acciones de los atacantes antes de que ocurran, pasando de un modelo reactivo a uno proactivo. |
| **Tema Particular 1** | Uso de algoritmos de Machine Learning supervisado para identificar patrones de tráfico malicioso | Análisis de Anomalías en Tráfico de Datos | Desarrollo de un modelo de Threat Hunting proactivo basado en Machine Learning para identificar amenazas persistentes avanzadas (APTs). Se busca analizar grandes volúmunes de datos de red y de endpoints para encontrar patrones sutiles que delaten una intrusión no detectada. |
| **Tema Específico 1** | Implementación de un sistema basado en Random Forest para la detección de ataques DDoS en entornos de nube | Aplicación de RNN para Identificar Ataques de Día Cero en Cloud Computing | Diseño y validación de un sistema basado en Redes Neuronales Recurrentes (RNN) para la detección temprana de patrones de movimiento lateral en redes corporativas. Este proyecto se centraría en analizar secuencias de eventos de logs de autenticación y acceso para predecir y alertar sobre el desplazamiento de un atacante dentro de la red antes de que alcance sus objetivos críticos. |

| Aspecto | ChatGPT | Grok | Gemini |
|---------|---------|------|--------|
| **Propuesta 2** | IA en la gestión de vulnerabilidades | Análisis de Malware | El Duelo de la IA: Ataque y Defensa Adversaria |
| **Tema General 2** | Aplicación de IA en la priorización de vulnerabilidades | Inteligencia Artificial en el Análisis y Clasificación de Malware | Estudio de las técnicas de Adversarial AI (IA Adversaria) tanto para la generación de ciberataques más sofisticados como para la creación de defensas robustas contra ellos. |
| **Tema Particular 2** | Uso de técnicas de NLP para analizar reportes de vulnerabilidades | Detección Basada en Comportamiento Dinámico | Análisis de la robustez de los sistemas de detección de malware basados en Deep Learning frente a ataques de evasión. La investigación se centraría en cómo los atacantes pueden modificar ligeramente el malware para que sea indetectable por los modelos de IA. |
| **Tema Específico 2** | Desarrollo de un modelo de clasificación automática de vulnerabilidades críticas usando BERT | Uso de Deep Learning para Predecir Variantes de Ransomware en Sistemas Móviles | Desarrollo de una metodología de "Adversarial Training" utilizando Redes Generativas Antagónicas (GANs) para fortalecer clasificadores de malware. El objetivo sería entrenar un modelo de detección no solo con muestras de malware conocido, sino también con variantes generadas artificialmente por una GAN, diseñadas específicamente para engañar al propio modelo, forzándolo a aprender características más resilientes.

 |

| Aspecto | ChatGPT | Grok | Gemini |
|---------|---------|------|--------|
| **Propuesta 3** | Deep Learning en ciberseguridad ofensiva y defensiva | Prevención de Fraudes | Automatización Inteligente de Operaciones de Seguridad (AIOps) |
| **Tema General 3** | Deep Learning aplicado a la ciberseguridad | Procesamiento de Lenguaje Natural en la Prevención de Fraudes Digitales | Aplicación de la Inteligencia Artificial para automatizar y orquestar las tareas del Centro de Operaciones de Seguridad (SOC), mejorando la eficiencia y reduciendo los tiempos de respuesta. |
| **Tema Particular 3** | Redes neuronales convolucionales para identificación de malware | Identificación de Phishing y Engaños en Comunicaciones | Creación de un sistema de triaje y priorización inteligente de alertas de seguridad utilizando Procesamiento del Lenguaje Natural (PLN) y algoritmos de clasificación. El sistema buscaría reducir la fatiga por alertas que sufren los analistas. |
| **Tema Específico 3** | Entrenamiento de CNN para detección temprana de ransomware en Windows | Implementación de Transformers para Detectar Correos Electrónicos Falsos | Implementación de un playbook de respuesta a incidentes de phishing automatizado mediante un modelo de Lenguaje Grande (LLM) y un sistema SOAR (Security Orchestration, Automation and Response). El sistema analizaría correos sospechosos reportados, extraería indicadores de compromiso (URLs, hashes), los enriquecería con fuentes de inteligencia de amenazas y ejecutaría acciones de contención (ej. bloquear URL en el firewall) de forma autónoma. |

| Aspecto | ChatGPT | Grok | Gemini |
|---------|---------|------|--------|
| **Propuesta 4** | IA para la seguridad en IoT | Evaluación de Vulnerabilidades |  IA para la Seguridad en el Internet de las Cosas (IoT) |
| **Tema General 4** | Inteligencia Artificial para la protección de dispositivos IoT | IA para la Evaluación y Gestión de Vulnerabilidades en Sistemas | Uso de la Inteligencia Artificial para proteger las redes de dispositivos IoT, que a menudo carecen de capacidades de seguridad robustas y presentan una superficie de ataque muy amplia. |
| **Tema Particular 4** | Sistemas de detección de anomalías en sensores conectados | Pruebas Automatizadas de Penetración | Detección de anomalías en el comportamiento de dispositivos IoT mediante aprendizaje no supervisado. La idea es crear una línea base del comportamiento normal de cada dispositivo y alertar sobre cualquier desviación significativa que pueda indicar un compromiso. |
| **Tema Específico 4** | Uso de Autoencoders para detectar comportamientos anómalos en IoT médico | Agentes de Reinforcement Learning para Simular Ataques en Infraestructuras Críticas | Modelo de detección de ataques de botnets en redes IoT utilizando "Federated Learning" (Aprendizaje Federado). Este enfoque permitiría entrenar un modelo global de detección de anomalías sin necesidad de centralizar los datos de tráfico de todos los dispositivos, preservando así la privacidad y reduciendo el consumo de ancho de banda. Cada dispositivo o grupo de dispositivos entrena un modelo local y solo comparte las actualizaciones del modelo, no los datos brutos. |

| Aspecto | ChatGPT | Grok | Gemini |
|---------|---------|------|--------|
| **Propuesta 5** | Explicabilidad de la IA en ciberseguridad | Explicabilidad y Ética | Gestión y Remediación Inteligente de Vulnerabilidades |
| **Tema General 5** | Explicabilidad e interpretabilidad de modelos de IA en ciberseguridad | Inteligencia Artificial Explicable en Decisiones de Ciberseguridad | Aplicación de la IA para optimizar el ciclo de vida de la gestión de vulnerabilidades, desde su descubrimiento hasta su remediación. |
| **Tema Particular 5** | Métodos de Explainable AI para justificar decisiones en IDS | Modelos Interpretables para Sistemas de Detección de Intrusiones | Desarrollo de un sistema de priorización de vulnerabilidades basado en el riesgo real utilizando modelos predictivos. A diferencia del puntaje CVSS tradicional, este sistema consideraría el contexto del activo, la probabilidad de explotación y el impacto potencial en el negocio. |
| **Tema Específico 5** | Aplicación de SHAP y LIME en IDS basado en Gradient Boosting | Aplicación de Técnicas de Explicabilidad en Firewalls Inteligentes | Creación de un modelo de "Graph Neural Network" (GNN) para predecir la probabilidad de explotación de vulnerabilidades en activos interconectados. El sistema modelaría la infraestructura de TI como un grafo, donde los nodos son los activos y las aristas sus conexiones. La GNN aprendería de la topología de la red y de los datos históricos de ataques para identificar qué vulnerabilidades presentan un riesgo más inminente para la organización. |

### Análisis de Coincidencias y Diferencias

**Coincidencias identificadas:**
- Los tres LLM coinciden en la importancia de la detección de amenazas e intrusiones
- Hay consenso en el uso de técnicas de aprendizaje automático y deep learning
- La explicabilidad de la IA aparece como tema común en ChatGPT y Grok
- Todos mencionan la aplicación práctica en entornos específicos (nube, móvil, IoT)

**Diferencias notables:**
- ChatGPT enfoca más en técnicas específicas de ML (Random Forest, BERT)
- Grok incluye aspectos éticos y de reinforcement learning
- Gemini es mucho más extenso con sus propuestas.

---

## 3. Validación con Bases de Datos Indexadas

### Paper 1
- **Autores:** Zaid Al-Khazaali1 , Ammar Al-Ghabban , Haneen Al-Musawi , Anwar Sabah , Noor Al Mahdi
- **Año:** 2025
- **Revista indexada:** Journal of Engineering and Sustainable Development
- **Conclusiones relevantes:** El estudio demuestra que es posible detectar escaneos realizados con Nmap usando características estadísticas del tráfico, como puertos de origen, distribución de puertos de destino y duración del escaneo. Estas métricas permiten diferenciar Nmap de otras herramientas como Metasploit, sentando las bases para futuros sistemas de detección más precisos.

### Paper 2
- **Autores:** Mohammed Ibrahim Kareem, Mohammad Jawad Kadhim Abood, Karrar Ibrahim
- **Año:** 2023
- **Revista indexada:** Bulletin of Electrical Engineering and Informatics
- **Conclusiones relevantes:** El estudio demuestra que el uso de machine learning con selección híbrida de características permite detectar con alta precisión el tráfico de escaneo malicioso. Algoritmos como JRip y OneR clasifican eficazmente entre tráfico legítimo y ataques de PortScan. Se sugiere aplicar este enfoque en entornos reales como SDN o IoT y con datasets más recientes.
### Paper 3
- **Autores:** Min Guo, Dongjuan Ma, Feng Jing, Xueqin Zhang, Hengwang Liu
- **Año:** 2025
- **Revista indexada:** Informatica
- **Conclusiones relevantes:** Este estudio presenta un enfoque innovador de defensa anti-mapeo basado en deep learning, que mejora la detección de anomalías y reduce falsos positivos mediante un modelo BiLSTM con atención. Aunque la técnica ofrece alta precisión y adaptabilidad, su alto consumo de recursos y complejidad limitan su adopción generalizada. Futuras investigaciones deben centrarse en la optimización de recursos y la simplificación del despliegue para facilitar su implementación, especialmente en entornos con recursos limitados.
...
4. Defensa Antiescaneo Multi-dimensional y Dinámica: Integrar una variedad de técnicas de defensa que actúen en concierto:
    ◦ Asignación dinámica de direcciones IP y ofuscación de geolocalización para dificultar la orientación a los atacantes.
...
2. Implementación de un modelo de clasificación basado en aprendizaje adaptativo online (ej. Hoeffding Tree o un Perceptrón actualizado continuamente) que sea sometido a técnicas de optimización (poda o cuantificación) para asegurar su despliegue en hardware con recursos limitados
